              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Order Total:     Ghc ${widget.order.totalPrice}'),
                    Text('Adress:            ${widget.order.address}')
                  ],
                ),
              ),
                ...
                child: Stepper(
                  ...
                  steps: [
                    Step(
                      ...
                      content: const Text(
                        'Your order is yet to be Approved',
                      ),
                    ...
                    Step(
                      ...
                      content: const Text(
                        'Your order has been sent by the Courier to be delivered to you.',
                      ),
                    ...
                    Step(
                      ...
                      content: const Text(
                        'Package received as confirmed by Courier...For any issues please contact the admin',
                      ),

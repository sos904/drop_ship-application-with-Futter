import 'dart:convert';
import 'dart:io';
import 'package:drop_ship/constants/error_handling.dart';
...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('ddtivketd', 'syyvuesv');
      ...
      FloatingSnackBar(context: context, message: e.toString());
    }
  }
    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            Sales('Food', response['mobileEarnings']),
            Sales('Books', response['essentialEarnings']),
            Sales('Electronics', response['booksEarnings']),
